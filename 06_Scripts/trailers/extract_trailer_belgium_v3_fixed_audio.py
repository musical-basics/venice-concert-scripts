#!/usr/bin/env python3
"""
extract_trailer_belgium_v3_fixed_audio.py
-----------------------------------------
V3 of the Belgium trailer — same as v2_fixed_audio but with all six
white-flash hits removed (no full-screen flash drawboxes between text
beats). Audio still sourced from the FIXED-audio WAV master.
...
Output:
  03_Cuts/Landscape/Moonlight Sonata TRAILER_BELGIUM_V3_FixedAudio.mp4
"""
...
OUTPUT      = "../../03_Cuts/Landscape/Moonlight Sonata TRAILER_BELGIUM_V3_FixedAudio.mp4"
START_TIME  = 230.0
DURATION    = 45.0
...
# ── TEXT BEATS (no white-flash hits — removed for V3) ───────────────────
...
print("\n🎬  GENERATING BELGIUM TRAILER V3 (FIXED AUDIO, NO FLASH) — 45s landscape...")
...
print(f"\n✅  TRAILER V3 (FIXED AUDIO, NO FLASH) COMPLETE! → {OUTPUT}")
