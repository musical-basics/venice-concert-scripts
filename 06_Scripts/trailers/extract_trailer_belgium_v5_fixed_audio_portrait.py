#!/usr/bin/env python3
"""
extract_trailer_belgium_v5_fixed_audio_portrait.py
--------------------------------------------------
Portrait 9:16 (1080x1920) version of V5, for YouTube Shorts.

Same timings + new copy as landscape V5:
  • Cold open: "MOONLIGHT SONATA / REIMAGINED"
  • Title card: "MOONLIGHT SONATA / NIGHTMARE"

Built from a center crop of the landscape master (608x1080 → 1080x1920).
...
Output:
  03_Cuts/Portrait/Moonlight Sonata TRAILER_BELGIUM_V5_FixedAudio_Portrait.mp4
"""
...
OUTPUT      = "../../03_Cuts/Portrait/Moonlight Sonata TRAILER_BELGIUM_V5_FixedAudio_Portrait.mp4"
START_TIME  = 230.0
DURATION    = 45.0
...
# Center crop landscape → 9:16 column, scale to 1080x1920
...
# Cold open — "MOONLIGHT SONATA / REIMAGINED"
# Sized to fit 1080-wide portrait. "MOONLIGHT SONATA" = 16 chars; 80pt keeps margin.
filters.append(dt("MOONLIGHT SONATA", BEBAS,  80, "(h-text_h)/2 - 80", 0.3, 5.5, attack=0.08, decay=0.4, borderw=3))
filters.append(dt("REIMAGINED",        BEBAS,  80, "(h-text_h)/2 + 70", 0.3, 5.5, attack=0.08, decay=0.4, borderw=3))
...
# Title card — "MOONLIGHT SONATA / NIGHTMARE" stacked, portrait-sized
filters.append(dt("MOONLIGHT SONATA", BEBAS, 120, "(h-text_h)/2 - 130", 28.5, 36.0, attack=0.12, decay=0.6, borderw=5, color=GOLD))
filters.append(dt("NIGHTMARE",         BEBAS, 170, "(h-text_h)/2 + 110", 28.5, 36.0, attack=0.12, decay=0.6, borderw=5, color=GOLD))
...
print("\n📱  GENERATING V5 PORTRAIT (NEW COPY) — 45s 9:16...")
